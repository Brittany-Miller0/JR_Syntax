package One_JavaSyntax.task.task_8.task_027;

 /*
 * Собираем семейство
 * 1.Создать класс Human с полями (String name, boolean sex, int age, children (ArrayLIst<Human>)
 * 2.Создать объекты и заполнить их так, чтобы получилось: 2 два дедушки, две бабушки, отец, мать , 3 детей.
 * 3.Выведи все объекты Human на экран (toString);
 */
